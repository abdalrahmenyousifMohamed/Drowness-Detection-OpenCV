...
# Notice how the bounding box of my face is drawn in green 
# while each of the individual facial landmarks are drawn in red


# we learned what facial landmarks are and how to detect them using dlib, OpenCV, and Python.
...
# Apply the shape predictor, specifically a facial landmark detector, to obtain the (x, y)-coordinates of the face regions in the face ROI(Region of Interest).
